...
Fachada_Servidor::Fachada_Servidor(Nat cantJugadores, const Fachada_Variante &variante, const Repositorio &r): servidor(Servidor(cantJugadores,variante.daVariante(),r)){
}
